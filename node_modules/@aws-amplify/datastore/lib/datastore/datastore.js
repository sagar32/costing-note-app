            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    if (aws_appsync_graphqlEndpoint) {
                        ...
                        sync = new sync_1.SyncEngine(schema, namespaceResolver, syncClasses, userClasses, storage, modelInstanceCreator, maxRecordsToSync, syncPageSize, conflictHandler, errorHandler);
                        ...
                        syncSubscription = sync
                            ...
                            next: function (_a) {
                                ...
                                if (type === sync_1.ControlMessage.SYNC_ENGINE_STORAGE_SUBSCRIBED) {
                                    initResolve();
                                }
